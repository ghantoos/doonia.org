server {                                                                                                                                                                                              
  listen      80;
  server_name  default doonia.org;

  access_log /var/log/nginx/doonia.org-access.log ;
  error_log /var/log/nginx/doonia.org-error.log warn;
  ...
  rewrite ^/$ http://doonia.org/en/lebanon/latest/ last;
  ...
  location /static/ {    
    root   /home/ghantoos/doonia.org/website;
